...
test "margin top should work for: line, block", ->
...
test "margin top should work for: block, line, when block starts with a break", ->
...
test "margin top should work for: line, block, when line ends with a break", ->
...
test "margin top should work for: line, block, when there are two breaks in between", ->
...
test "margin bottom should work for: line, block", ->
...
test "margin bottom should work for: block, line", ->
...
test "margin bottom should work for: block, line, when block ends with a break", ->
...
test "margin bottom should work for: block, line, when line starts with a break", ->
...
test "margin bottom should work for: block, line, when there are two breaks in between", ->
...
test "a(top: 0, bottom: 0) b(top: 1, bottom: 0)", ->
...
test "a(top: 0, bottom: 1) b(top: 0, bottom: 0)", ->
...
test "a(top: 0, bottom: 1   ) b(   top: 1, bottom: 0)", ->
...
test "a(top: 0, bottom: 1 br) b(br top: 1, bottom: 0)", ->
